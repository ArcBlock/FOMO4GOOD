...
for (let tries = 0; ; tries++) {
  realResponse = await request(`${origin}/arc/api/fomo/state`);
...
const closed = await request(`${origin}/arc/api/fomo/intents`, {method:'POST',headers:{Origin:origin,'Content-Type':'application/json'},body:'{}'});
